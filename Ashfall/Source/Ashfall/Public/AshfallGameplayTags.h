...
namespace AshfallGameplayTags
{
	...
	ASHFALL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_HitPause);	
	...
	ASHFALL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Event_HitPause);	
	...
	//Enemy Tag
	ASHFALL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Enemy_Ability_Melee);
	ASHFALL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Enemy_Ability_Ranged);

	ASHFALL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Enemy_Weapon);	

	//Shared Tag
	ASHFALL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_Ability_HitReact);

	ASHFALL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_Event_MeleeHit);
	ASHFALL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_Event_HitReact);
